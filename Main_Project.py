...
#метод для редактирования в дочернем окне:
    def open_update_child(self):
        Update()

#метод для поиска данных в дочернем окне:
    def open_searc(self):
        Search()
...
#виджеты для дочернего окна:
    def init_child(self):
        self.title("Добавление контакта")
        self.geometry("400x200")
        self.resizable(False, False)

#контролируем все события:
        self.grab_set()
...
#класс изменения данных для дочернего окна:
class Update(Child):
    def __init__(self):
        super().__init__()
        self.init_update()
